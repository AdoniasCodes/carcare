    ...
    <section id="services" className="py-20 sm:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-accent font-semibold text-sm uppercase tracking-wider">{t("services.eyebrow")}</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-primary mt-2 mb-4">{t("services.title")}</h2>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed text-sm">{t(service.descKey)}</p>
                <div className="flex items-center justify-between">
                  <p className="text-accent font-semibold text-sm">{t("services.priceFrom")}</p>
                </div>
              </div>
            </div>
          ))}
